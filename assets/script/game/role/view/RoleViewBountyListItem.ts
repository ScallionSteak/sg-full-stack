...
/** 角色摇撼控制 */
@ccclass("RoleViewBountyListItem")
@ecs.register('RoleViewBountyListItem', false)
export class RoleViewBountyListItem extends CCComp {
    ...
    initData(bountyListItem: any) {
        ...
        this.bountyDesc.getComponent(Label).string = bountyListItem.bountyDesc;
        ...
        this.bountyContact.getComponent(Label).string = bountyListItem.bountyContact;
    }
